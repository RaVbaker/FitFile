...
const messages = {
    'file_id': {
        ...
        fields: {
            ...
            time_created:  {number: 4, base_type: 134},
    ...
    'record': {
        ...
        fields: {
            ...
            position_lat:              {number:   0, base_type: 131},
            position_long:             {number:   1, base_type: 131},
            distance:                  {number:   5, base_type: 134},
            time_from_course:          {number:  11, base_type: 133}, // empty
            compressed_speed_distance: {number:   8, base_type: 13},  // empty
            heart_rate:                {number:   3, base_type: 2},
            altitude:                  {number:   2, base_type: 132},
            speed:                     {number:   6, base_type: 132},
            power:                     {number:   7, base_type: 132},
            grade:                     {number:   9, base_type: 131}, // empty
            cadence:                   {number:   4, base_type: 2},
            resistance:                {number:  10, base_type: 2},   // empty
            cycle_length:              {number:  12, base_type: 2},   // empty
            temperature:               {number:  13, base_type: 1},   // empty
            enhanced_altitude:         {number:  78, base_type: 134}, // empty
            enhanced_speed:            {number:  73, base_type: 134}, // empty
    ...
    'lap': {
        ...
        fields: {
            ...
            start_position_long: {number:   4, base_type: 133}, // 0.0
	          ...
	          total_elapsed_time:  {number:   0, base_type: 134},
